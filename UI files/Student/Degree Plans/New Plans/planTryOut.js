...
$(document).ready(function(){
	...
	$submitPrefs.click(function(event){
		...
		$.ajax({
			...
			data: {
				MajorID: dgs.val();
				SchoolID: uniOptions.val();
				JobType: jobType.val();
				TotalQuarterCredits: creditPerQuarter.val();
				MajorQuarterCredits: majorCreditPerQuarter.val();
				EngCourseID: engClass.val();
				MathCourseID: mathClass.val();
				Status: "1";
				SummerPreference: summerOption.val();
				EnrollmentType: enrollType.val();
			},
